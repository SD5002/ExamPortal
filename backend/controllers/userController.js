...
export const register= wrapAsync(async (req, res,next) => {
  ...
  if(existedUser){
      return next(new ExpressError(409,"User alredy Exist with given Email"))      
  }
  ...
  if (!createdUser){
    next(new ExpressError(500,"Something Went wronge while regestring user"))
  }
